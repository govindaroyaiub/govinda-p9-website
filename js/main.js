$(document).ready(function () {
  ...
  $servicesToggle.on("click", function (e) {
    e.preventDefault(); // Prevent default link behavior
    $servicesDropdown.toggleClass("collapse-active");
  });
});

const subscriptionButton = document.getElementById("mc-embedded-subscribe");
...
subscriptionButton.addEventListener("click", (e) => {
  // Smoothly fade out the subscription form
  subscriptionContainer.classList.add("hide");
...
function islandAnimation() {
  ...
  $(window).scroll(function () {
    ...
    let bg_laptop = document.getElementById('bg_laptop');
    let planet1_laptop = document.getElementById('planet1_laptop');
    let big_island_laptop = document.getElementById('big_island_laptop');
    let small_island_left_laptop = document.getElementById('small_island_left_laptop');
    let small_island_laptop = document.getElementById('small_island_laptop');
    let middle_island_laptop = document.getElementById('middle_island_laptop');
    let planet2_laptop = document.getElementById('planet2_laptop');
    let grass_laptop = document.getElementById('grass_laptop');
    let cloud1_laptop = document.getElementById('cloud1_laptop');
    let cloud2_laptop = document.getElementById('cloud2_laptop');
    let sun_laptop = document.getElementById('sun_laptop');
    let header_text_laptop = document.getElementById('header__text_laptop');

    let bg_black_laptop = document.getElementById('bg_black_laptop');
    let planet1_black_laptop = document.getElementById('planet1_black_laptop');
    let big_island_black_laptop = document.getElementById('big_island_black_laptop');
    let small_island_left_black_laptop = document.getElementById('small_island_left_black_laptop');
    let small_island_black_laptop = document.getElementById('small_island_black_laptop');
    let middle_island_black_laptop = document.getElementById('middle_island_black_laptop');
    let planet2_black_laptop = document.getElementById('planet2_black_laptop');
    let grass_black_laptop = document.getElementById('grass_black_laptop');
    let cloud1_black_laptop = document.getElementById('cloud1_black_laptop');
    let cloud2_black_laptop = document.getElementById('cloud2_black_laptop');
    let sun_black_laptop = document.getElementById('sun_black_laptop');
    let header_text_black_laptop = document.getElementById('header__textBlack_laptop');
    let header_paralaxBlack_laptop = document.getElementsByClassName('header__paralaxBlack_laptop');
    var circleWrap = document.querySelector('.circleWrap');
    ...
    // if(header_paralaxBlack)
      ...
      if( !(value2 >= 790) ) {
        ...
        // header_text_black.style.marginBottom = value2 * 0.025 + '%';
        sun_black.style.marginBottom = value2 * -0.01 + '%';
        ...
        // header_text_black.style.marginBottom = value2 * 0.025 + '%';
        sun_black_laptop.style.marginBottom = value2 * -0.01 + '%';
      }
      ...
      if( !(value >= 790) ) {
        ...
        // header_text.style.marginBottom = value * 0.025 + '%';
        sun.style.marginBottom = value * -0.01 + '%';
        ...
        // header_text.style.marginBottom = value * 0.025 + '%';
        sun_laptop.style.marginTop = value * 0.01 + '%';
      }
